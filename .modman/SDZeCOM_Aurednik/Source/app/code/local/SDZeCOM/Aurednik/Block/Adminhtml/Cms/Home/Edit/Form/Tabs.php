 ...
 *
 */
class SDZeCOM_Aurednik_Block_Adminhtml_Cms_Home_Edit_Form_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	public function __construct()
	{
		...
		$this->setId('aurednik_cms_home_edit');

		$this->setDestElementId('aurednik_cms_home_edit');
	}
