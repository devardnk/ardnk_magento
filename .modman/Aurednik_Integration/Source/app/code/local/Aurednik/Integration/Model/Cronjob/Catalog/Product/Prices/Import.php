 ...
 *
 */
class Aurednik_Integration_Model_Cronjob_Catalog_Product_Prices_Import extends Aurednik_Integration_Model_Cronjob_Abstract
{
	...
	{
		return $this->factory()->getServiceInCatalogProductPricesImport();
	}
