 ...
 *
 */
class Aurednik_Integration_Model_Cronjob_Catalog_Product_Import extends Aurednik_Integration_Model_Cronjob_Abstract
{
	...
	{
		return $this->factory()->getServiceInCatalogProductImport();
	}
