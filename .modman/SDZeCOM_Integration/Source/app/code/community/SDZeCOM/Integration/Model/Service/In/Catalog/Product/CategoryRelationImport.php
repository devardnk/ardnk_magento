 ...
 * @author mwalter
 */
class SDZeCOM_Integration_Model_Service_In_Catalog_Product_CategoryRelationImport
    extends SDZeCOM_Integration_Model_Service_In_Abstract
{
    protected $indexes = array( // @todo check this
        'catalog_product_attribute' => 1,
        'catalog_url'               => 1,
    ...
    protected function processData(array $products)
    {
        ...
        $import->processCategoryProductImport($products);
